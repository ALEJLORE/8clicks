...
<h1 class="mb-4">Database Backup and Restore</h1>
        
        <a href="backupdb.php" class="btn btn-primary">Backup Database</a>

        <!-- Restore Database Button -->
        <a href="restoredb.php" class="btn btn-success">Restore Database</a>
