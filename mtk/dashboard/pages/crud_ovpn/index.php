...
$result = mysqli_query($mysqli, "SELECT * FROM vpn ORDER BY id DESC");
?>
    ...
    <table class="table table-bordered table-striped" id="myTable">
        ...
        <tbody>
            ...
            while ($res = mysqli_fetch_assoc($result)) {
                echo "<tr>";
                echo "<td>".$res['device_name']."</td>";
                echo "<td>".$res['device_mac']."</td>";
				echo "<td>".$res['device_ip']."</td>";
				echo "<td>".$res['port_service']."</td>";
				echo "<td>".$res['vpn_service_port']."</td>";
				echo "<td>".$res['status']." <a href=\"ping.php?id=$res[id]\" class='btn btn-info btn-sm'>Ping</a>|</td>";
								
                echo "<td><a href=\"edit.php?id=$res[id]\" class='btn btn-primary btn-sm'>Manage</a>| 
				<a href=\"install.php?id=$res[id]\" class='btn btn-success btn-sm'>Install</a>| 
				<a href=\"generate.php?id=$res[id]\" class='btn btn-warning btn-sm'>script</a>| 
