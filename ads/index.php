...
<head>
	...
	<link href="css/tkads.css" rel="stylesheet" />    
...
<!--  H1 can have 2 designs: "logo" and "logo cursive"           -->
        ...
        <div class="content">
            <h4 class="motto">Get early access to latest demos of our products and services.</h4>
            <div class="subscribe">
                <h5 class="info-text">
    ...
    <div class="footer">
      <div class="container">
             Made with <i class="fa fa-heart heart"></i> by <a href="http://www.tkssc.net">TKSSC</a>. See our Cloud Hosted Hotspot Management <a href="http://localhost/mtk/dashboard/">here.</a>
      </div>
    </div>
 </div>
 </body>
